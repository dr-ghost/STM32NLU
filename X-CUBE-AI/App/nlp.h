...
/******************************************************************************/
#define AI_NLP_MODEL_NAME          "nlp"
#define AI_NLP_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_NLP_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NLP_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NLP_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NLP_IN_NUM        (1)

AI_DEPRECATED
#define AI_NLP_IN \
  ai_nlp_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NLP_IN_SIZE { \
  AI_NLP_IN_1_SIZE, \
}
#define AI_NLP_IN_SIZE_BYTES { \
  AI_NLP_IN_1_SIZE_BYTES, \
}
#define AI_NLP_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NLP_IN_1_CHANNEL     (10)
#define AI_NLP_IN_1_SIZE        (10)
#define AI_NLP_IN_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_NLP_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NLP_OUT \
  ai_nlp_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NLP_OUT_SIZE { \
  AI_NLP_OUT_1_SIZE, \
}
#define AI_NLP_OUT_SIZE_BYTES { \
  AI_NLP_OUT_1_SIZE_BYTES, \
}
#define AI_NLP_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NLP_OUT_1_CHANNEL     (3)
#define AI_NLP_OUT_1_SIZE        (3)
#define AI_NLP_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_NLP_N_NODES (8)
 ...
 * @ref ai_nlp_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_NLP_*
 * defines into file @ref nlp.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
